...
/**
 * Control strip for the 2D membrane simulation.
 *
 * <p>Provides sliders for wave speed and damping, plus a Reset button that
 * clears the membrane displacement.
 */
class MembraneControls extends JPanel {
    ...
    private final MembranePanel panel;

    MembraneControls(WaveMembrane model, MembranePanel panel) {
        this.model = model;
        this.panel = panel;
        ...
        // Amplitude slider: 10 – 200 mapped to 0.1 – 2.0
        add(namedSlider("Amplitude (×0.01)", 10, 200, (int)(panel.amplitude * 100),
